...
using BESL.Infrastructure.SteamWebAPI2.Models;
using BESL.Infrastructure.SteamWebAPI2.Models.CSGO;
using BESL.Infrastructure.SteamWebAPI2.Models.DOTA2;
using BESL.Infrastructure.SteamWebAPI2.Models.GameEconomy;
using BESL.Infrastructure.SteamWebAPI2.Models.SteamCommunity;
using BESL.Infrastructure.SteamWebAPI2.Models.SteamEconomy;
using BESL.Infrastructure.SteamWebAPI2.Models.SteamPlayer;
using BESL.Infrastructure.SteamWebAPI2.Models.SteamStore;
using BESL.Infrastructure.SteamWebAPI2.Models.TF2;
        ...
        public static void Initialize()
        {
            ...
            if (config == null)
            {
                config = new MapperConfiguration(x =>
                {
                    ...
                    x.CreateMap<SteamLevelResultContainer, uint?>().ConvertUsing(src => src != null ? src.Result.PlayerLevel : (uint?)null);

                    x.CreateMap<OwnedGame, OwnedGameModel>()
                    .ForMember(dest => dest.PlaytimeLastTwoWeeks, opts => opts.MapFrom(src =>
                        src != null ? TimeSpan.FromMinutes(src.Playtime2weeks.Value) : (TimeSpan?)null))
                    .ForMember(dest => dest.PlaytimeForever, opts => opts.MapFrom(src =>
