...
namespace BESL.Persistence.Migrations
{
    ...
    [Migration("20190621080444_IntroduceTeamTableResultAndCompetitionTables")]
    partial class IntroduceTeamTableResultAndCompetitionTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BESL.Entities.CompetitionTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BESL.Entities.CompetitionTable", b =>
                {
                    b.HasOne("BESL.Entities.Competition", "Competition")
                        .WithMany("Tables")
            ...
            modelBuilder.Entity("BESL.Entities.Match", b =>
                {
                    ...
                    b.HasOne("BESL.Entities.TeamTableResult", "CompetitionTableResult")
            ...
            modelBuilder.Entity("BESL.Entities.Team", b =>
                {
                    b.HasOne("BESL.Entities.CompetitionTable", "CurrentActiveCompetitionTable")
            ...
            modelBuilder.Entity("BESL.Entities.TeamTableResult", b =>
                {
                    b.HasOne("BESL.Entities.CompetitionTable", "CompetitionTable")
