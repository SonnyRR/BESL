    ...
    public class GameLookupModel : IHaveCustomMapping
    {
        ...
        public void CreateMappings(Profile configuration)
        {
            configuration.CreateMap<Game, GameLookupModel>()
                .ForMember(glm => glm.Description, o => o.MapFrom(g => string.Format("{0}", g.Description.Length > 140 ? $"{g.Description.Substring(0, g.Description.IndexOf('.', 140))}..." : g.Description)))
